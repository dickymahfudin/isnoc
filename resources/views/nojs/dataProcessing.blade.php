...
@section('content1')
    <div class="container mt-3 mb-3">
        ...
        <div class="card-header font-weight-bold">Data Processing
        </div>
            ...
            <div class="card-body bg-light text-dark">
                ...
                <div class="row justify-content-center">
                    <div class="form-group col-md-5 ">
                        <select  data-live-search="true" class="form-control selectpicker h-50 d-inline-block" data-size="5" data-style="btn-primary" title="NOJS" url="{{ route('nojs.table') }}" urlProcesing="{{ route('noc.logger') }}">
                        </select>
                    </div>
                ...
                <div class="row justify-content-center mt-5 d-none" id="collapsebtn">
                    <div class="col-md-5">
                        <a class="btn btn-coll btn-success" data-toggle="collapse" href="#datatableresult"  role="button" aria-expanded="false" id="daily">Daily</a>
                        <a class="btn btn-coll btn-success" data-toggle="collapse" href="#datatable" role="button" aria-expanded="false" id="loggers">Logger</a>
                    </div>
                    <div class="col-md-5">
                    </div>
                </div>

                <div class="mt-5 d-none" id="container-chart">
                    <canvas id="chart"></canvas>
                </div>

                <div class="collapse show container mt-3" id="datatableresult"></div>
                <div class="collapse container mt-3" id="datatable"></div>
...
@push('scripts1')
    <script type="module" src="{{ asset('js/nojs/dataProcessing.js') }}" defer></script>
