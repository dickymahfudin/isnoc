...
@section('content1')
    <div class="container mt-3 mb-3">
        ...
        <div class="card-header font-weight-bold">SLA PRTG
        </div>
            ...
            <div class="card-body bg-light text-dark">
                ...
                <div class="container mt-2 d-none" id="datatable" url="{{route('apislaprtg')}}">
                </div>
...
@push('scripts1')
    <script type="module" src="{{ asset('js/slaprtg/sla.js') }}" defer></script>
