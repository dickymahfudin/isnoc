...
@section('content1')
    <div class="container mt-3 mb-3">
        ...
        <div class="card-header font-weight-bold">Status History
        </div>
            ...
            <div class="card-body bg-light text-dark">
                ...
                <div class="container mt-2 d-none" id="datatable" url="{{route('apistateprtg')}}">
                </div>
...
@push('scripts1')
    <script src="{{ asset('js/slaprtg/state.js') }}" defer></script>
